...
public class MenuView extends JFrame {
  ...
  public MenuView() {
    ...
    ImageIcon imageTondeuse = new ImageIcon(new ImageIcon(getClass().getClassLoader().getResource("image/tondeuse.png")).getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT));
